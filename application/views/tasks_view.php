        ...
        <div class="col-md-12">
            <form name="myForm" method="post" action="/tasks/add" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="user" placeholder="Ваше имя" ng-model="task.user"
                           required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="pic" name="pic" class="btn  btn-default" ng-model="task.pic"
